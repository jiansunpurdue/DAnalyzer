...
HFVirtualDecay::HFVirtualDecay(const edm::ParameterSet& iConfig) :
	...
	fTracksLabel(iConfig.getUntrackedParameter<edm::InputTag>("tracksLabel", edm::InputTag("hiSelectedTracks"))),
	fTrackQualityString(iConfig.getUntrackedParameter<std::string>("trackQualityString",std::string("highPurity"))),
	fPrimaryVertexLabel(iConfig.getUntrackedParameter<edm::InputTag>("PrimaryVertexLabel", edm::InputTag("hiSelectedVertex"))),
