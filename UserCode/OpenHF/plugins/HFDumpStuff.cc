...
HFDumpStuff::HFDumpStuff(const edm::ParameterSet& iConfig):
    ...
    fPrimaryVertexLabel(iConfig.getUntrackedParameter<InputTag>("PrimaryVertexLabel", InputTag("hiSelectedVertex"))),
    fPrimaryVertexTracksLabel(iConfig.getUntrackedParameter<InputTag>("PrimaryVertexTracksLabel", InputTag("hiSelectedTracks")))
{
    cout << "----------------------------------------------------------------------" << endl;
