...
//	  if ( trackView.numberOfValidHits() < 13 )  continue;  // 
//	  if ( trackView.ptError()/trackView.pt() > 0.05)  continue;  // 
//	  if ( trackView.normalizedChi2()/trackView.numberOfValidHits() > 0.15)  continue; // not sure about this yet
